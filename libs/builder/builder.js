...
/* drag and drop */
	...
	getHtml: function(keepHelperAttributes = true) {
		...
		doc.querySelectorAll('.swiper-slide').forEach(el => {el.classList.remove('swiper-slide-active','swiper-slide-next','swiper-slide-prev');el.removeAttribute('data-swiper-slide-index');el.style.removeProperty('width');});
